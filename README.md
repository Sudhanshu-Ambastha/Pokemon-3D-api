...
|---------------------|---------------|-----------|---------------------------------------------------------------------------------|
| **Regular Forms**   | 956            | 1028      | Standard Pokémon forms from Generations 1 to 9 including male & female.        |
| **Shiny Forms**     | 114           | 1028      | Alternate color variants of all standard Pokémon.                              |
...
| **MegaShiny Evolutions** | 5         | 49        | Includes both single Mega forms and X/Y variants.                              |
