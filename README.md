...
|---------------------|---------------|-----------|---------------------------------------------------------------------------------|
| **Regular Forms**   | 958            | 1028      | Standard Pokémon forms from Generations 1 to 9 including male & female.        |
| **Shiny Forms**     | 121           | 1028      | Alternate color variants of all standard Pokémon.                              |
...
| **Fusion Forms** | 4 | 6 | Kyurem (black/white), Necrozma (Dusk Mane/Dawn Wings), Calyrex (Ice Rider/Shadow Rider)           |
